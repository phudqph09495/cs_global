class ModelListMostSale {
  List<MostSaleProduct>? mostSaleProduct;

  ModelListMostSale({this.mostSaleProduct});

  ModelListMostSale.fromJson(Map<String, dynamic> json) {
    if (json['mostSaleProduct'] != null) {
      mostSaleProduct = <MostSaleProduct>[];
      json['mostSaleProduct'].forEach((v) {
        mostSaleProduct!.add(new MostSaleProduct.fromJson(v));
      });
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.mostSaleProduct != null) {
      data['mostSaleProduct'] =
          this.mostSaleProduct!.map((v) => v.toJson()).toList();
    }
    return data;
  }
}

class MostSaleProduct {
  int? id;
  String? code;
  String? name;
  String? thumbnail;
