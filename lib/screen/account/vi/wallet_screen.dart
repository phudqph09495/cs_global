                  ...
                  Padding(
                    ...
                    child: Column(
                      children: [
                                  ...
                                  Row(
                                   ...
                                   RowInfo(
                                      ...
                                      score: '${modelProfile
                                          .walletProfile!.score}'),
                                   RowInfo(
                                      title: 'Tiền tiêu dùng : ', score: '${Const.convertPrice(modelProfile
                                       .walletProfile!.totalCost)} đ'),
                                   RowInfo(
                                      title: 'Phí quản lý tài khoản : ',
                                      score: '${Const.formatPrice(modelProfile
                                          .walletProfile!.manageFee)} đ'),
                                ],
                              ),
                            )
                          ],
                        ...
                        InkWell(
                          onTap: (){
                            Navigator.push(context, MaterialPageRoute(builder: (context)=>ViCsScreen())).then((value) => blocProfile.add(GetData()));
                          },
                          child: Container(
                            width: double.infinity,
                            height: 60,
