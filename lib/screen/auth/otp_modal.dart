...
//                   ),
//                   Text('Vui lòng nhập mã xác nhận gồm 6 chữ số đã được gửi về số điện thoại ${Const.convertPhone('${widget.phone}',isHint: true)}',style: StyleApp.textStyle500(),textAlign: TextAlign.center,)
//                 ],
//               ),
//             ),
//
